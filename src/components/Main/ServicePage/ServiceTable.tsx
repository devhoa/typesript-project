...
const ServiceTable = ({ data }: { data: Data }) => {
          ...
          <table className="table table-striped table-hover table-bordered mb-0">
            ...
            <tbody className="">
              {data.slice(currentIndex, endPosition).map((service: any) => {
                return (
                  <tr key={service.id}>
                    <td className="py-17 ps-17">{service.id}</td>
                    <td className="py-17 ps-17">{service.name}</td>
                    <td className="py-17 ps-17">{service.desc}</td>
                    ...
                    <td className="py-17 ps-17">
                      <a href="/view-service">Chi tiết</a>
                    </td>
                    <td className="py-17 ps-17">
                      <a href="/edit-service">Cập nhật</a>
                    </td>
                  </tr>
                );
              })}
